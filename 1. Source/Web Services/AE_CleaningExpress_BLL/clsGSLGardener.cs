...
namespace AE_CleaningExpress_BLL
{
    public class clsGSLGardener
    {
        ...
        public DataSet Get_GSLGardener_Project(DataSet oDTCompanyList, string sCompany, string sCurrentUserName, string sUserRole)
        {
            ...
            try
            {
                sFuncName = "Get_GSLGardener_Project()";
                sProcName = "AE_SP028_Mobile_GSLGardener_GetProject";
        ...
        public DataSet Get_GSLGardener_ListofGardener(DataSet oDTCompanyList, string sCompany, string sProjectCode)
        {
            DataSet oDataset = new DataSet();
            string sFuncName = string.Empty;
            string sProcName = string.Empty;
            ...
            try
            {
                sFuncName = "Get_GSLGardener_ListofGardener()";
                sProcName = "AE_SP029_Mobile_GSLGardener_ListofGardener";
                if (p_iDebugMode == DEBUG_ON) oLog.WriteToDebugLogFile("Starting Function ", sFuncName);
        ...
        public DataSet Get_GSLGardener_ViewGardenerDetails(DataSet oDTCompanyList, string sCompany, string sDocEntry)
        {
            DataSet oDataset = new DataSet();
            string sFuncName = string.Empty;
            string sProcName = string.Empty;
            ...
            try
            {
                sFuncName = "Get_GSLGardener_ViewGardenerDetails()";
                sProcName = "AE_SP030_Mobile_GSLGardener_ViewGardenerDetails";
                if (p_iDebugMode == DEBUG_ON) oLog.WriteToDebugLogFile("Starting Function ", sFuncName);
        ...
        public DataSet Get_GSLGardener_GetTemplate(DataSet oDTCompanyList, string sCompany)
        {
            DataSet oDataset = new DataSet();
            string sFuncName = string.Empty;
            string sProcName = string.Empty;
            ...
            try
            {
                sFuncName = "Get_GSLGardener_GetTemplate()";
                sProcName = "AE_SP031_Mobile_GSLGardener_GetTemplate";
                if (p_iDebugMode == DEBUG_ON) oLog.WriteToDebugLogFile("Starting Function ", sFuncName);
