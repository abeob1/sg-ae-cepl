Public Class Form1
        ...
        Try
            ...
            If lRetCode <> 0 Then
                ...
                Else
                    ...
                    MsgBox(sErrMsg & " " & oUserTablesMD.TableName)
                End If
            Else
    ...
    Private Sub Add_AE_Cdriver_Fields()
        ...
        If lRetCode <> 0 Then
            ...
            Else
                oCompany.GetLastError(lRetCode, sErrMsg)
                MsgBox(sErrMsg & " " & oUserFieldsMD.TableName & " " & oUserFieldsMD.Name)
            End If
        Else
    ...
    Private Sub Add_AE_Sdriver_Fields()
        ...
        oUserFieldsMD.Description = "Monthly Charges"
        oUserFieldsMD.Type = SAPbobsCOM.BoFieldTypes.db_Float
        oUserFieldsMD.SubType = SAPbobsCOM.BoFldSubTypes.st_Price
        oUserFieldsMD.EditSize = 9
        ...
        oUserFieldsMD.Description = "Recurring Descrip"
        oUserFieldsMD.Type = SAPbobsCOM.BoFieldTypes.db_Alpha
        oUserFieldsMD.SubType = SAPbobsCOM.BoFldSubTypes.st_None
        oUserFieldsMD.EditSize = 150
    ...
    Private Sub Add_AE_SM_R_Fields()
        ...
        oUserFieldsMD.ValidValues.Description = "AirconRepair"
        oUserFieldsMD.ValidValues.Add()

        oUserFieldsMD.ValidValues.Value = "Battery"
        oUserFieldsMD.ValidValues.Description = "BatteryChange"
        oUserFieldsMD.ValidValues.Add()
    ...
    Private Sub Add_AE_SMMS_R2_Fields()
        ...
        oUserFieldsMD.TableName = "@AE_SMMS_R2"
    ...
    Private Sub Add_AE_OHEM_Fields()
        ...
        oUserFieldsMD.ValidValues.Value = "CTL"
        oUserFieldsMD.ValidValues.Description = "Citilux"
        oUserFieldsMD.ValidValues.Add()

        oUserFieldsMD.ValidValues.Value = "D01"
        oUserFieldsMD.ValidValues.Description = "Bliss Limo aka Ding"
        oUserFieldsMD.ValidValues.Add()

        oUserFieldsMD.ValidValues.Value = "DTS"
        oUserFieldsMD.ValidValues.Description = "DownTown Travel Services"
        oUserFieldsMD.ValidValues.Add()

        oUserFieldsMD.ValidValues.Value = "E-CLASS"
        oUserFieldsMD.ValidValues.Description = "Freelance E-Class"
        oUserFieldsMD.ValidValues.Add()

        oUserFieldsMD.ValidValues.Value = "H01"
        oUserFieldsMD.ValidValues.Description = "Orchid Limo aka Hak"
        oUserFieldsMD.ValidValues.Add()

        oUserFieldsMD.ValidValues.Value = "IMP"
        oUserFieldsMD.ValidValues.Description = "Imperial Chauffeur"
        oUserFieldsMD.ValidValues.Add()

        oUserFieldsMD.ValidValues.Value = "JSP"
        oUserFieldsMD.ValidValues.Description = "Jospeh for luggage van"
        oUserFieldsMD.ValidValues.Add()

        oUserFieldsMD.ValidValues.Value = "PH01"
        oUserFieldsMD.ValidValues.Description = "JQ Transport 44's Coach"
        oUserFieldsMD.ValidValues.Add()

        oUserFieldsMD.ValidValues.Value = "PH02"
        oUserFieldsMD.ValidValues.Description = "JQ Transport Minibus"
        oUserFieldsMD.ValidValues.Add()

        oUserFieldsMD.ValidValues.Value = "RAC"
        oUserFieldsMD.ValidValues.Description = "RMG Rent-A-Car (In-house Staff and Part Timer)"
        oUserFieldsMD.ValidValues.Add()

        oUserFieldsMD.ValidValues.Value = "RMGT"
        oUserFieldsMD.ValidValues.Description = "RMG Tours (Coach and Minibus)"
        oUserFieldsMD.ValidValues.Add()
    ...
    Private Sub AddUDO_Cdriver()
        ...
        oUserObjectMD.FindColumns.ColumnAlias = "U_AE_Bcode"
        oUserObjectMD.FindColumns.ColumnDescription = "Billing Code"
        oUserObjectMD.FindColumns.Add()
        ...
        If lRetCode <> 0 Then
            ...
            End If
        Else
            Label3.Text = "UDO: " & oUserObjectMD.Name & " was added successfully"
        End If
    ...
    Private Sub AddUDO_PriceList()
        ...
        oUserObjectMD.FindColumns.ColumnAlias = "U_AE_Pcode"
        oUserObjectMD.FindColumns.ColumnDescription = "Price List Code"
        oUserObjectMD.FindColumns.Add()
    ...
    Private Sub AddUDO_ServiceMAintenance()
        ...
        oUserObjectMD.FormColumns.FormColumnAlias = "U_AE_Vno"
        ...
        oUserObjectMD.FindColumns.ColumnAlias = "U_AE_Vno"
        oUserObjectMD.FindColumns.ColumnDescription = "Vehicle Number"
        oUserObjectMD.FindColumns.Add()
    ...
    Private Sub AddUDO_TrafficeOffense()
        ...
        oUserObjectMD.FindColumns.ColumnAlias = "U_AE_Cate"
        oUserObjectMD.FindColumns.ColumnDescription = "Category"
        oUserObjectMD.FindColumns.Add()
