...
#Region "Varibles Declarations"
    ...
    Public Structure CompanyDefault
        ...
        Public sSAPBankCode As String
        Public sSAPBankAccount As String
        ...
        Public ProjectDimension As String
    ...
    Public p_sJournalEntryError As String = String.Empty
    Public p_sOutgoingPaymentError As String = String.Empty
...
#End Region
    ...
    Sub Main()
        ...
        Try
            ...
            Console.WriteLine("Calling IdentifyCSVFile_JournalEntry() ", sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Calling IdentifyCSVFile_JournalEntry() ", sFuncName)
            If IdentifyCSVFile_JournalEntry(sErrDesc) <> RTN_SUCCESS Then Throw New ArgumentException(sErrDesc)

            Console.WriteLine("Calling IdentifyCSVFile_OutgoingPayments() ", sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Calling IdentifyCSVFile_OutgoingPayments() ", sFuncName)
            If IdentifyCSVFile_OutgoingPayments(sErrDesc) <> RTN_SUCCESS Then Throw New ArgumentException(sErrDesc)
