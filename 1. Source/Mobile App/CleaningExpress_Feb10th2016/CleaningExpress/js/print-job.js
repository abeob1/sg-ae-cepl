...
$(document).ready(function(){
	...
	$('#form-field-2').datepicker({
        format: "mm/dd/yyyy"
    });

//$("#form-field-1").attr("minDate",getToday()); 
 //$("#form-field-2").attr("minDate",getToday());
   ...
   // Print pdf to Open Job completion report in new tab
    ...
    $("#print").click(function () {
        ...
        if (companyUser) {
		 ...
		 var fromdate = $('#form-field-1').val();
		 var todate = $('#form-field-2').val();
		...
		mProjectData["FromDate"] = fromDate;
		mProjectData["ToDate"] = toDate;
...
function validateRequired(callBack){
	...
	if($("#form-field-select-1").val()==""){
		...
		errorMsg = "Please select FromDate.";
	}
	else if($("#form-field-2").val() == ""){
		errorMsg = "Please select ToDate.";
	}
	callBack(errorMsg);
