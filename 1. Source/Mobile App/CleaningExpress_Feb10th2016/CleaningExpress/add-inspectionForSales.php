...
<body>
			...
			<div class="main-wrapper">
				...
				<div class="main-container inner"   ng-app="myApp" id="angular" ng-controller="InspectionMainCtrl" >
					...
					<div class="main-content">
						<div class="container">
							<a href="list-inspectionForSales.php" class="addStock"><h3 class="stock"><i class="fa fa-angle-left"></i> Add Inspection Q/A</h3></a>
							<div id="stock-list">
		...
		<script type="text/javascript" src="js/add-inspectionForSales.js"></script>
</body>
<!-- end: BODY -->
</html>