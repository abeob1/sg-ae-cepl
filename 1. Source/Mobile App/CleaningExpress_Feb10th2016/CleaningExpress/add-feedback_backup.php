						...
						<div class="questions">
							...
							<form role="form" class="form-horizontal" method="post" action="">
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-5 col-xs-6 fedtext" style="text-align:center;">
										<!-- <input class="form-control" type="text" id="esign" maxlength="30"/> -->
										<div id="sigCapture" class="paddtop" style="text-align:center" ><div id="esign"></div><i class="fa fa-refresh clear fedesign" id="clear" title="clear"></i></div>
									</div>
								</div>
								</div>
								<div class="clearfix"></div>
