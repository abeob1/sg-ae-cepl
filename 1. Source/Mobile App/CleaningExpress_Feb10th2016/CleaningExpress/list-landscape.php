...
<html lang="en">
	...
	<body>
				...
				<div class="main-content">
					<div class="container">
						<div class="col-md-12 col-sm-12 col-xs-12 stock">
							<div class="pull-left">
								<a href="dashboard.php"><h3 class=""><i class="fa fa-angle-left"></i> GSL Landscape Checklist</h3></a>
							</div>	
							<div class="pull-right header">
								<a href="dashboard.php"><i class="fa fa-backward"></i> Back</a>
								<a href="add-landscape.php" class="addls cHide"><i class="fa fa-plus"></i> New</a>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-md-12 col-sm-12 col-xs-12">	
											...
											<div class="row" style="margin-right:15px;">
												<div class="col-md-3 col-sm-3 col-xs-3"><strong>Doc Name</strong></div>
												<div class="col-md-3 col-sm-3 col-xs-3"><strong>Doc Date</strong></div>
												<div class="col-md-3 col-sm-3 col-xs-3 mrgl-5"><strong>Supervisor Name</strong></div>
												<div class="col-md-3 col-sm-3 col-xs-3"><strong>Client Name</strong></div>
											</div>
											<div class="clearfix"></div>
											<div id="scrollbox3">
		...
		<script type="text/javascript" src="js/list-landscape.js"></script>
	</body>
	<!-- end: BODY -->
</html>