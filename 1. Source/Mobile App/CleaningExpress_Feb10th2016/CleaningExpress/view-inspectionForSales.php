...
<body>
			...
			<div class="main-wrapper">
				...
				<div class="main-container inner" ng-app="myApp" id="angular" ng-controller="InspectionViewCtrl">
					...
					<div class="main-content">
						<div class="container">
							<a href="list-inspectionForSales.php" class="addStock"><h3 class="stock"><i class="fa fa-angle-left"></i> View Inspection Q/A</h3></a>
							<div id="stock-list">
		...
		<script>$("#inspection1").addClass('active');</script>
		<script>$("#tree3").addClass('treeview active');</script>

		<script src="js/jsign/jSignature.min.js"></script>
		<script type="text/javascript" src="js/view-inspectionForSales.js"></script>
</body>
<!-- end: BODY -->
</html>