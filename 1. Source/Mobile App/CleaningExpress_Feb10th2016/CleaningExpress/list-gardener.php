...
<html lang="en">
	...
	<body>
				...
				<div class="main-content">
					<div class="container">
                        <div class="col-md-12 col-sm-12 col-xs-12 stock">
							<div class="pull-left">
								<a href="dashboard.php"><h3 class=""><i class="fa fa-angle-left"></i> GSL Gardener Checklist</h3></a>
							</div>	
							<div class="pull-right header">
								<a href="dashboard.php"><i class="fa fa-backward"></i> Back</a>
								<a href="add-gardener.php" class="addGard cHide"><i class="fa fa-plus"></i>New</a>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-md-12 col-sm-12 col-xs-12">	
											...
											<div class="row" style="margin-left:2px;">
												<div class="col-md-3 col-sm-3 col-xs-2"><strong>Doc Name</strong></div>
		...
		<script type="text/javascript" src="js/list-gardener.js"></script>
	</body>
	<!-- end: BODY -->
</html>