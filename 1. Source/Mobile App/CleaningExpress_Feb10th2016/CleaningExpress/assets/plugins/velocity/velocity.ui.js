...
(function() {
    ...
    *************/
    ...
    if (!Container.Velocity.version || (Container.Velocity.version.major <= 0 && Container.Velocity.version.minor <= 5 && Container.Velocity.version.patch <= 0)) {
    ...
    Container.Velocity.RegisterUI = function (effectName, properties) {
        ...
        function animateParentHeight (elements, direction, totalDuration, stagger) {
            ...
            Container.Velocity.Utilities.each(elements, function(i, element) {
                ...
                Container.Velocity.CSS.setPropertyValue(element, "display", "");
