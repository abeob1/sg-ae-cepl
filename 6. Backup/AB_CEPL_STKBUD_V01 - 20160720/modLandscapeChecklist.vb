Module modLandscapeChecklist

    Function LandscapeChecklist_LoadScreen(ByRef oForm As SAPbouiCOM.Form, ByRef sErrDesc As String) As Long
        ...
        Try
            ...
            Dim Tmp_val As String = oForm.BusinessObject.GetNextSerialNumber(NextSerialNo(p_oDICompany, p_oSBOApplication, "LandscapeChecklist"))
            ...
            sQueryString = "SELECT TOP 1 DocEntry  FROM [@AB_LANDSCAPECHK] ORDER BY DocEntry DESC"
            ...
            LandscapeChecklist_LoadScreen = RTN_SUCCESS
        Catch ex As Exception
            sErrDesc = ex.Message().ToString()
            Call WriteToLogFile(sErrDesc, sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with ERROR", sFuncName)
            LandscapeChecklist_LoadScreen = RTN_ERROR
        End Try
    End Function

    Function LandscapeChecklist_EnableControl(ByRef oForm As SAPbouiCOM.Form, ByRef sErrDesc As String) As Long
        ...
        Try
            ...
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with SUCCESS", sFuncName)
            LandscapeChecklist_EnableControl = RTN_SUCCESS

        Catch ex As Exception
            sErrDesc = ex.Message().ToString()
            Call WriteToLogFile(sErrDesc, sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with ERROR", sFuncName)
            LandscapeChecklist_EnableControl = RTN_ERROR
        End Try
    End Function

    Function LandscapeChecklist_DisableControl(ByRef oForm As SAPbouiCOM.Form, ByRef sErrDesc As String) As Long
        ...
        Try
            ...
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with SUCCESS", sFuncName)
            LandscapeChecklist_DisableControl = RTN_SUCCESS

        Catch ex As Exception
            sErrDesc = ex.Message().ToString()
            Call WriteToLogFile(sErrDesc, sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with ERROR", sFuncName)
            LandscapeChecklist_DisableControl = RTN_ERROR
        End Try
    End Function
