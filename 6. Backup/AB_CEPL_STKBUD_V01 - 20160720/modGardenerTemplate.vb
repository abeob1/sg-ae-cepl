Module modGardenerTemplate

    Function GardenerTemplate_Loadscreen(ByRef oForm As SAPbouiCOM.Form, ByRef sErrDesc As String) As Long
        ...
        Try
            sFuncName = "GardenerTemplate_Loadscreen()"
            ...
            sQueryString = "SELECT Code FROM [@AB_GARDENERTEMPLATE]"
            ...
            If oRS.RecordCount > 0 Then
                ...
                If (oMatrix.Columns.Item("V_2").Cells.Item(oMatrix.VisualRowCount).Specific.string <> "") Then
                    ...
                    oForm.DataSources.DBDataSources.Item("@AB_GARDENERTEMPLINE").Clear()
                    oMatrix.AddRow(1)
            ...
            GardenerTemplate_Loadscreen = RTN_SUCCESS
        Catch ex As Exception
            oForm.Freeze(False)
            sErrDesc = ex.Message().ToString()
            Call WriteToLogFile(sErrDesc, sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with ERROR", sFuncName)
            GardenerTemplate_Loadscreen = RTN_ERROR
        End Try
    End Function

    Function GardenerTemplate_Matrix_AddRow(ByRef oForm As SAPbouiCOM.Form, ByRef sErrDesc As String) As Long

        Dim oMatrix As SAPbouiCOM.Matrix
        Dim oCheckBox As SAPbouiCOM.CheckBox
        Try
            sFuncName = "GardenerTemplate_Matrix_AddRow()"
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Starting Function", sFuncName)
            oMatrix = oForm.Items.Item("matContent").Specific
            ...
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with SUCCESS", sFuncName)
            GardenerTemplate_Matrix_AddRow = RTN_SUCCESS

        Catch ex As Exception
            sErrDesc = ex.Message().ToString()
            Call WriteToLogFile(sErrDesc, sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with ERROR", sFuncName)
            GardenerTemplate_Matrix_AddRow = RTN_ERROR
        End Try
    End Function

    Function GardenerTemplate_ValidateQuestion(ByRef oForm As SAPbouiCOM.Form, ByRef sErrDesc As String) As Long
        ...
        Try
            sFuncName = "GardenerTemplate_ValidateQuestion()"
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Starting Function", sFuncName)
            oRS = p_oDICompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            oMatrix = oForm.Items.Item("matContent").Specific

            sQueryString = "SELECT Code FROM [@AB_GARDENERTEMPLINE] WHERE Code='" & oForm.Items.Item("txtCode").Specific.string & "' AND U_Sort='" & p_iGardenerTemplate & "'"
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Executing Query : " & sQueryString, sFuncName)
            ...
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with SUCCESS", sFuncName)
            GardenerTemplate_ValidateQuestion = RTN_SUCCESS

        Catch ex As Exception
            sErrDesc = ex.Message().ToString()
            Call WriteToLogFile(sErrDesc, sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with ERROR", sFuncName)
            GardenerTemplate_ValidateQuestion = RTN_ERROR
        End Try
    End Function

    Function GardenerTemplate_DeleteEmptyRows(ByRef oForm As SAPbouiCOM.Form, ByRef sErrDesc As String) As Long
        ...
        Try
            sFuncName = "GardenerTemplate_DeleteEmptyRows()"
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Starting Function", sFuncName)

            oRS = p_oDICompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)

            sQueryString = "DELETE FROM [@AB_GARDENERTEMPLINE] WHERE Code ='" & oForm.Items.Item("txtCode").Specific.string & "' AND U_Question IS NULL"
            ...
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with SUCCESS", sFuncName)
            GardenerTemplate_DeleteEmptyRows = RTN_SUCCESS

        Catch ex As Exception
            sErrDesc = ex.Message().ToString()
            Call WriteToLogFile(sErrDesc, sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with ERROR", sFuncName)
            GardenerTemplate_DeleteEmptyRows = RTN_ERROR
        End Try
    End Function

    Function GardenerTemplate_Validation(ByRef oForm As SAPbouiCOM.Form, ByRef sErrDesc As String) As Long

        Dim oMatrix As SAPbouiCOM.Matrix

        Try

            sFuncName = "GardenerTemplate_Validation()"
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Starting Function", sFuncName)
            oMatrix = oForm.Items.Item("matContent").Specific
            ...
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with SUCCESS", sFuncName)
            GardenerTemplate_Validation = RTN_SUCCESS

        Catch ex As Exception
            sErrDesc = ex.Message().ToString()
            Call WriteToLogFile(sErrDesc, sFuncName)
            If p_iDebugMode = DEBUG_ON Then Call WriteToLogFile_Debug("Completed with ERROR", sFuncName)
            GardenerTemplate_Validation = RTN_ERROR
        End Try
    End Function
